document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateTextVisibility() {
    if (
      !isBreakthroughReached &&
      isElementInViewport(leftText) &&
      isElementInViewport(rightText)
    ) {
      ...
      isBreakthroughReached &&
      (!isElementInViewport(leftText) || !isElementInViewport(rightText))
    ) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateTextVisibility() {
    ...
    panels.forEach(function (panel) {
      ...
      if (
        scrollY + windowHeight - buffer > panelTop &&
        scrollY + buffer < panelTop + rect.height
      ) {
